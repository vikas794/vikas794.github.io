...
const CONTACT_LINKS: ContactLinkItem[] = [
  {
    ...
    icon: Mail,
    label: "Email",
    value: "vikasjaiswal794@gmail.com",
    href: "mailto:vikasjaiswal794@gmail.com",
  },
  {
    id: "linkedin",
    icon: Linkedin,
    label: "LinkedIn",
    value: "linkedin.com/in/vikasjaiswall",
  ...
  },
  {
    ...
    icon: Twitter,
    label: "X (Twitter)",
    value: "@VikasJa09548053",
    href: "https://x.com/VikasJa09548053",
  },
  {
    id: "whatsapp",
    icon: MessageCircle,
    label: "WhatsApp",
    value: "+91 82915 19911",
    href: "https://wa.me/918291519911",
  },
  {
    id: "telegram",
    icon: TelegramIcon,
    label: "Telegram",
    value: "t.me/Vikas7",
    href: "https://t.me/Vikas7",
  },
  {
    id: "location",
    icon: MapPin,
    label: "Location",
    value: <>Santacruz, Mumbai 400055 <span className="map-hint">↗ map</span></>,
    isLocation: true,
  },
];
                ...
                {CONTACT_LINKS.map((link) => {
                  if (link.isLocation) {
                    return (
                      ...
                      >
                        <div className="cl-icon"><link.icon size={18} /></div>
